    ...
    return (
      <section className="py-24 bg-white min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-4 px-7 py-5 rounded-3xl border border-white/80 bg-white/75 backdrop-blur-xl shadow-2xl shadow-slate-300/40">
          ...
          <div>
            <p className="text-slate-900 text-lg font-black">Cargando videos</p>
            <p className="text-slate-500 text-sm">Preparando contenido multimedia...</p>
          </div>
        </div>
      </section>
    );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
            ...
            {videos.length === 0 ? (
              <div className="relative overflow-hidden rounded-[2rem] border bg-white/78 backdrop-blur-xl p-16 text-center shadow-2xl shadow-slate-300/30">
                ...
                <p className="text-slate-500">
                  Pronto subiremos nuevo contenido.
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                {videos.map((video, index) => {
                  ...
                  return (
                    <div
                      key={video.video_id}
                      className="group relative overflow-hidden rounded-[2rem] border bg-white/78 backdrop-blur-xl transition-all duration-500 hover:-translate-y-3"
                      style={{
                    ...
                    >
                      ...
                      <div
                        className="relative z-10 aspect-video cursor-pointer overflow-hidden rounded-t-[2rem] bg-white"
                        onClick={() => {
                      ...
                      >
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div
                            className="w-17 h-17 sm:w-16 sm:h-16 rounded-full bg-white/92 backdrop-blur-sm border-4 border-white flex items-center justify-center group-hover:scale-110 transition-all shadow-xl"
                            style={{
                        ...
                        <span className="absolute bottom-3 right-3 px-3 py-1.5 rounded-full bg-red-600 text-white text-xs font-black flex items-center gap-1 shadow-lg">
                      ...
                      <div className="relative z-10 p-5">
                        <span
                          className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-black text-white mb-3"
                          style={{
                        ...
                        <h3 className="text-xl font-black text-slate-900 line-clamp-2 mb-2 leading-tight">
                          {video.video_titulo}
                        </h3>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              >
                <Play className="w-10 h-10 mx-auto mb-3" style={{ color: colors.primario }} />

                <p className="text-sm text-slate-500 mb-3">
                  Mira más contenido académico e institucional.
                </p>

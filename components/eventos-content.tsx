...
export default function EventosContent({ colors }: EventosContentProps) {
  ...
  useEffect(() => {
    const cargarTodo = async () => {
      try {
        ...
        setEventos(eventsData.upea_evento || []);
    ...
    return (
      <section className="py-24 bg-white min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-4 px-7 py-5 rounded-3xl border border-white/80 bg-white/75 backdrop-blur-xl shadow-2xl shadow-slate-300/40">
          ...
          <div>
            <p className="text-slate-900 text-lg font-black">Cargando eventos</p>
            <p className="text-slate-500 text-sm">Preparando actividades institucionales...</p>
          </div>
        </div>
      </section>
    );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col gap-5">
                      ...
                      <div
                        ...
                        onClick={() => evento.evento_imagen && setSelectedImage(evento.evento_imagen)}
                      >
                        ...
                        <div className="flex flex-col gap-3 text-sm text-slate-600">
                          {evento.evento_fecha && (
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                <b className="text-slate-800">Fecha:</b> {formatDate(evento.evento_fecha)}
                              </span>
                            </div>
                          )}
                          ...
                          {evento.evento_hora && (
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                <b className="text-slate-800">Hora:</b> {evento.evento_hora}
                              </span>
                            </div>
                          )}
                          ...
                          {evento.evento_lugar && (
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                <b className="text-slate-800">Lugar:</b> {evento.evento_lugar}
                              </span>
                            </div>
                          )}
                        </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              >
                <Calendar className="w-10 h-10 mx-auto mb-3" style={{ color: colors.primario }} />

                <p className="text-sm text-slate-500 mb-3">
                  Mantente al tanto de nuevas actividades y eventos académicos.
                </p>

        ...
        <div className="relative z-10 flex items-center gap-4 px-7 py-5 rounded-3xl border border-white/80 bg-white/75 backdrop-blur-xl shadow-2xl shadow-slate-300/40">
          <div
            ...
            style={{
              ...
              boxShadow: `0 18px 40px ${colors.secundario}25`,
            }}
          >
          ...
          <div>
            <p className="text-slate-900 text-lg font-black">Cargando comunicados</p>
            <p className="text-slate-500 text-sm">Preparando información oficial...</p>
          </div>
        </div>
      </section>
    );
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="text-center mb-14">
          <div
            ...
            style={{
              borderColor: `${colors.secundario}35`,
              backgroundColor: `${colors.secundario}10`,
              boxShadow: `0 18px 45px ${colors.secundario}18`,
            }}
          >
            <span
            ...
            {comunicados.length === 0 ? (
              <div className="relative overflow-hidden rounded-[2rem] border bg-white/78 backdrop-blur-xl p-16 text-center shadow-2xl shadow-slate-300/30">
                ...
                <p className="text-slate-500">
                  Pronto publicaremos nuevos comunicados.
                </p>
              </div>
            ) : (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-6">
                      ...
                      <div 
                        ...
                        style={{
                          borderColor: `${colors.secundario}22`,
                      ...
                      >
                        {comunicado.con_foto_portada ? (
                          ...
                          <div
                            ...
                            style={{
                              background: `linear-gradient(135deg, ${colors.secundario}18, ${colors.terciario}14)`,
                            }}
                          >
                            <FileText
                        ...
                        <div className="mb-4">
                          <span 
                            ...
                            style={{
                              ...
                              boxShadow: `0 12px 28px ${colors.secundario}28`,
                            }}
                          >
                            Comunicado Oficial
                          </span>
                        ...
                        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 text-sm text-slate-600">
                          {comunicado.con_fecha_inicio && (
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                <b className="text-slate-800">Fecha:</b> {formatDate(comunicado.con_fecha_inicio)}
                              </span>
                            </div>
                          )}
                        </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              <div
                ...
                style={{
                  borderColor: `${colors.secundario}30`,
                  boxShadow: `0 20px 50px ${colors.secundario}12`,
                }}
              >
                <FileText className="w-10 h-10 mx-auto mb-3" style={{ color: colors.secundario }} />

                <p className="text-sm text-slate-500 mb-3">
                  Revisa comunicados oficiales e información importante de la carrera.
                </p>
                ...
                <a
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${colors.secundario}, ${colors.terciario})`,
                    boxShadow: `0 14px 28px ${colors.secundario}25`,
                  }}
                >
                  Más información
                </a>

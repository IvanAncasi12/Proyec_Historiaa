    ...
    return (
      <section className="py-24 bg-white min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-4 px-7 py-5 rounded-3xl border border-white/80 bg-white/75 backdrop-blur-xl shadow-2xl shadow-slate-300/40">
          ...
          <div>
            <p className="text-slate-900 text-lg font-black">Cargando servicios</p>
            <p className="text-slate-500 text-sm">Preparando servicios de la carrera...</p>
          </div>
        </div>
      </section>
    );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col gap-5">
                      ...
                      <div
                        ...
                        onClick={() => servicio.serv_imagen && setSelectedImage(servicio.serv_imagen)}
                      >
                        {servicio.serv_imagen ? (
                          <img
                            src={servicio.serv_imagen}
                      ...
                      <div>
                        ...
                        {servicio.serv_nro_celular && (
                          <div className="flex items-center gap-2 text-sm text-slate-600">
                            ...
                            <span>
                              <b className="text-slate-800">Contacto:</b> {servicio.serv_nro_celular}
                            </span>
                          </div>
                        )}
                      </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              >
                <Briefcase className="w-10 h-10 mx-auto mb-3" style={{ color: colors.primario }} />

                <p className="text-sm text-slate-500 mb-3">
                  Encuentra información y apoyo mediante los servicios disponibles.
                </p>

    ...
    return (
      <section className="py-24 bg-white min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-4 px-7 py-5 rounded-3xl border border-white/80 bg-white/75 backdrop-blur-xl shadow-2xl shadow-slate-300/40">
          ...
          <div>
            <p className="text-slate-900 text-lg font-black">Cargando gacetas</p>
            <p className="text-slate-500 text-sm">Preparando ediciones universitarias...</p>
          </div>
        </div>
      </section>
    );
            ...
            {gacetas.length === 0 ? (
              <div className="relative overflow-hidden rounded-[2rem] border bg-white/78 backdrop-blur-xl p-16 text-center shadow-2xl shadow-slate-300/30">
                ...
                <h3 className="text-2xl font-black text-slate-900 mb-2">
                  No hay gacetas disponibles
                </h3>

                <p className="text-slate-500">
                  Pronto publicaremos nuevas ediciones.
                </p>
              </div>
            ) : (
              <div className="space-y-5">
                {gacetas.map((gaceta, index) => (
                  <div
                    ...
                    className="group relative overflow-hidden rounded-[2rem] border bg-white/78 backdrop-blur-xl p-6 transition-all duration-500 hover:-translate-y-2"
                    style={{
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
                      <div
                        className="w-20 h-20 rounded-[1.5rem] flex items-center justify-center flex-shrink-0 border bg-white shadow-xl group-hover:scale-105 transition-transform"
                        style={{
                          color: colors.primario,
                        ...
                        <div className="flex items-center justify-center md:justify-start gap-4 text-sm text-slate-600">
                          {gaceta.gaceta_fecha && (
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                <b className="text-slate-800">Fecha:</b> {formatDate(gaceta.gaceta_fecha)}
                              </span>
                            </div>
                          )}
                        </div>
                      ...
                      {gaceta.gaceta_documento && (
                        <a
                          ...
                          className="relative z-10 flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-black text-sm transition-all hover:scale-105 text-white"
                          style={{
                            background: `linear-gradient(135deg, ${colors.primario}, ${colors.terciario})`,
            ...
            <div className="sticky top-24 space-y-6">
              ...
              >
                ...
                <p className="text-sm text-slate-500 mb-3">
                  Consulta gacetas universitarias y documentos oficiales disponibles.
                </p>

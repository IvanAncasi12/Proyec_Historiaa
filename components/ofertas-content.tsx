    ...
    return (
      <section className="py-24 bg-white min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-4 px-7 py-5 rounded-3xl border border-white/80 bg-white/75 backdrop-blur-xl shadow-2xl shadow-slate-300/40">
          ...
          <div>
            <p className="text-slate-900 text-lg font-black">Cargando ofertas</p>
            <p className="text-slate-500 text-sm">Preparando oportunidades académicas...</p>
          </div>
        </div>
      </section>
    );
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col gap-5">
                      ...
                      <div
                        ...
                        onClick={() => oferta.ofertas_imagen && setSelectedImage(oferta.ofertas_imagen)}
                      >
                      ...
                      <div>
                        ...
                        >
                          {oferta.ofertas_referencia || 'Oferta'}
                        </span>
                        ...
                        <div className="flex flex-col gap-3 text-sm text-slate-600">
                          ...
                          {oferta.ofertas_fecha_examen && (
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                <b className="text-slate-800">Examen:</b> {formatDate(oferta.ofertas_fecha_examen)}
                              </span>
                            </div>
                          )}
                        </div>
            ...
            <div className="sticky top-24 space-y-6">
              ...
              >
                ...
                <p className="text-sm text-slate-500 mb-3">
                  Mantente atento a nuevas oportunidades académicas.
                </p>
